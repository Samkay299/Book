  ...
  return (
    <div>
        ...
        <div class="text-center move">
                  ...
                  <p class="lead text-muted">Here are some of our FAQs. If you have any other questions <br /> you'd like answered please feel free to email us</p>
                </div>
    ...
    {data && <MoreAccordion/>}
          ...
          <button onClick={() => setData(!data)}>{data? 'Less Info' : 'More Info'}</button>
            </div>
        </div>
    </div>
  )
